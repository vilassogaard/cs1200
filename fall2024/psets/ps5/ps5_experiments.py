...
def benchmark():
    ...
    subgraph_line_parameter_range = (300, 300, 100)
    cluster_graph_p_parameter_range = (0.4, 0.95, 0.15)
    cluster_graph_cluster_size_parameter_range = (2, 20, 2)
    cluster_graph_cluster_quantity_parameter_range = (4, 5, 1)
